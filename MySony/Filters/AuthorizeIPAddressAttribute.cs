...
namespace MyProject.Filters
{
    public class AuthorizeIPAddressAttribute : ActionFilterAttribute
    {
        ...
        /// <summary>
        /// Compares an IP address to list of valid IP addresses attempting to find a match
        /// </summary>
        ...
        public static bool IsIpAddressValid(string ipAddress)
        {
            ...
            {
                if (Convert.ToString(HttpContext.Current.Request.Cookies["token"].Value) == GenToken()) return true;
            }
            ...
            string addresses = Convert.ToString(ConfigurationManager.AppSettings["AuthorizeIPAddresses"]);
