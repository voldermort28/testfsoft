...
namespace MySony.Functions
{
    ...
    {
        public static DataTable D_Datatable= new DataTable();
...
#region HELPER_FUNCTIONS
        ...
        public static DataTable ListToDataTable<T>(List<T> list)
        {
            ...
            foreach (PropertyInfo info in typeof(T).GetProperties())
            {
                ...
                D_Datatable.Columns.Add(new DataColumn(info.Name, GetNullableType(info.PropertyType)));
            }
            foreach (T t in list)
            {
        ...
        public static DataTable GetDataTable<T>(IList<T> data , DataTable table)
        {
            PropertyDescriptorCollection properties =
               TypeDescriptor.GetProperties(typeof(T));
        ...
        public static bool CreateExcelDocumentList<T>(List<T> list, string filename, System.Web.HttpResponse Response )
        {
            try
            {
                DataSet ds = new DataSet();
                ...
                //ds.Tables.Add(ListToDataTable(list));
                ds.Tables.Add(dt);
                CreateExcelDocumentAsStreamList(ds, filename, Response);
                return true;
            }
            catch (Exception ex)
            {
        ...
        private static void ExportToOxml(bool firstTime, DataTable ResultsData , string fileName)
        {
            try
            {
        ...
        private static void ExportToOxml(bool firstTime, DataTable ResultsData, MemoryStream stream)
        {
            try
            {
